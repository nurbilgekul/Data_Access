...
namespace LinqToSQL.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_CalisanlariListele_Result> sp_CalisanlariListele()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_CalisanlariListele_Result>("sp_CalisanlariListele");
        }
